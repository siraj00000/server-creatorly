...
class CampaignAssignmentController {
    async createCampaignAssignment(req, res, next) {
        try {
            ...
            const newCampaignAssignments = sub_brand_ids.map((sub_brand_id) => ({
                campaign_id,
                sub_brand_id,
                status
            }));
    ...
    async fetchAssignedCampaign(req, res, next) {
        try {
    ...
    async updateCampaignAssignmentStatus(req, res, next) {
        try {
            const { campaignAssignmentId } = req.params;
    ...
    async deleteCampaignAssignment(req, res, next) {
        try {
            const { campaignAssignmentId } = req.params;
...
//# sourceMappingURL=campaignAssignment.controllers.js.map