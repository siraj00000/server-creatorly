...
class MyBrandController {
    async createMyBrand(req, res, next) {
        try {
            if (!req.file) {
    ...
    async fetchMyBrands(req, res, next) {
        try {
    ...
    async fetchSpecificMyBrand(req, res, next) {
        try {
            const { id } = req.params;
            let singleMyBrand;
            let allMyBrands;
    ...
    async updateMyBrand(req, res, next) {
        try {
            const { id } = req.params;
    ...
    async deleteMyBrand(req, res, next) {
        try {
            const { id } = req.params;
...
//# sourceMappingURL=myBrand.controller.js.map