...
class SingleCreatorCampaignController {
    async createSingleCampaign(req, res, next) {
        try {
    ...
    async fetchCampaign(req, res, next) {
        try {
    ...
    async fetchCampaignById(req, res, next) {
        try {
    ...
    async fetchCampaignsByBrandId(req, res, next) {
        try {
    ...
    async fetchCampaignsByCreatorId(req, res, next) {
        try {
    ...
    async updateCampaignbyId(req, res, next) {
        try {
    ...
    async deleteCampaignById(req, res, next) {
        try {
...
//# sourceMappingURL=singleCreatorCampaign.controller.js.map