...
class BlogPostController {
    public async createBlogPost(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            if (!req.file) {
    ...
    public async fetchBlogs(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
    ...
    public async fetchSpecificBlogs(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
            const { id } = req.params;
            let singleBlogPost;
            let allBlogPost;
