...
class CreatorCustomLinkController {
    public async createCustomLink(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
    ...
    public async fetchCustomLinks(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
    ...
    public async fetchCustomLinkById(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
    ...
    public async updateCustomLinkById(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
    ...
    public async deleteCustomLinkById(req: Request, res: Response, next: NextFunction): Promise<void> {
        try {
